function showAPIKey(keyType, key)
{
	...
	if (keyType=='location') $('#apiKeyModalBody').html('<p>If you are using a RadioThermostat brand device, you will need to install the client application on your computer to ping the thermostat and notify ThermostatMonitor.com whenever the temperature or operating state changes.  First <a href="https://github.com/AndroidThermostat/ThermostatMonitor-Node/raw/master/client/downloads/thermostat-monitor-client.zip">download the client</a> and unzip it.  Then <a href="/cp/location/config/' + key + '">download your config file</a> and follow the <a href="https://github.com/AndroidThermostat/ThermostatMonitor-Node/blob/master/client/README.md">installation instructions</a>.</p>');
