...
generateBaseClass = (tableName, columns) ->
	...
	result.push tab(3) + "Global.getPool().query \"INSERT INTO " + tableName + " SET ?\", columns, (err, result) =>" + newline()
	...
	result.push tab(3) + "Global.getPool().query \"UPDATE " + tableName + " SET ? WHERE id = \" + @id, columns, cb" + newline()
	result.push tab(1) + "@load = ( id, cb ) ->" + newline()
	result.push tab(2) + "Global.getPool().query \"SELECT * FROM " + tableName + " where id = \" + id, (err, rows) =>" + newline()
	...
	result.push tab(2) + "Global.getPool().query \"DELETE FROM " + tableName + " where id = \" + id, (err, rows) =>" + newline()
	...
	result.push tab(2) + "Global.getPool().query query, params, (err, rows) =>" + newline()
